        ...
        {caseStudies.map((item) => (
          ...
          >
            ...
            <div className="p-6 space-y-4">
               ...
               className="inline-flex items-center px-3 py-1 text-xs font-semibold uppercase tracking-wider text-indigo-700 bg-indigo-100 rounded-full "/>
              ...
              className="text-gray-800 text-sm pt-2 font-extrabold line-clamp-3" />
